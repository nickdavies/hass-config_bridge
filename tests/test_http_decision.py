"""Every branch of the HTTP decision, since most of them only happen when
something has already gone wrong — exactly when you don't want to find out."""
...
from custom_components.config_bridge.model.http import (
    ERROR_APPLY_FAILED,
    ERROR_NOT_PROMOTED,
    HttpAction,
    decide_http,
