...
It also exports `claim_devices` and `claim_entities`, for other
integrations to pin their own (`claims.py`).
...
from .claims import claim_devices, claim_entities
...
__all__ = ["CONFIG_SCHEMA", "async_setup", "claim_devices", "claim_entities"]
